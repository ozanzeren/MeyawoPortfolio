...
namespace MeyawoPortfolio.Models
{
    ...
    public partial class DbMyPortfolioEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> LastReferanceCommet()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("LastReferanceCommet");
        }
    
        public virtual ObjectResult<string> LastThreeMessage()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("LastThreeMessage");
        }
    
        public virtual ObjectResult<string> ThirdReferanceComment()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("ThirdReferanceComment");
        }
    }
}
